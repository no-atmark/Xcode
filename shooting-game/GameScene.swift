...
//  shooting-game
//
//  Created by のあっと on 2019/10/31.
//  Copyright © 2019 のあっと. All rights reserved.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView){
        ...
        self.spaceship.scale(to: CGSize(width: 150,height: frame.width / 5))
        ...
        let bestScoreLabel = SKLabelNode(text: "Best Socre: \(bestScore)")
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?){
        ...
        let moveToTop = SKAction.moveTo(y: frame.height + 10, duration: 0.5)
    ...
    func gameOver() {
        ...
        Timer.scheduledTimer(withTimeInterval: 1.0, repeats: false) {
            _ in self.gameVC.dismiss(animated: true, completion: nil)
        }
    }
